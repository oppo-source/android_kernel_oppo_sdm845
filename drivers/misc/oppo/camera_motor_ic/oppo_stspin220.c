...
static int stspin220_init_dir_switch(struct oppo_sts_chip * chip)
{
	int ret = 0;
...
static int stspin220_init_sleep_gpio(struct oppo_sts_chip * chip)
{
	int ret = 0;
