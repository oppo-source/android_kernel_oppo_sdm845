...
static ssize_t motor_direction_store(struct class *class, struct class_attribute *attr,
...
#ifdef CONFIG_MOTOR_CLASS_INTERFACE
static ssize_t motor_speed_store(struct class *class, struct class_attribute *attr,
...
#ifdef CONFIG_MOTOR_CLASS_INTERFACE
static ssize_t motor_speed_show(struct class *class, struct class_attribute *attr, char *buf)
#else
...
#ifdef CONFIG_MOTOR_CLASS_INTERFACE
static ssize_t motor_mode_store(struct class *class, struct class_attribute *attr,
			   const char *buff, size_t count)
#else
...
#ifdef CONFIG_MOTOR_CLASS_INTERFACE
static ssize_t motor_enable_store(struct class *class, struct class_attribute *attr,
					const char *buff, size_t count)
#else
...
#ifdef CONFIG_MOTOR_CLASS_INTERFACE
static ssize_t motor_change_speed_store(struct class *class, struct class_attribute *attr,
						const char *buff, size_t count)
#else
...
#ifdef CONFIG_MOTOR_CLASS_INTERFACE
static ssize_t motor_sw_switch_store(struct class *class, struct class_attribute *attr,
						const char *buff, size_t count)
#else
...
#ifdef CONFIG_MOTOR_CLASS_INTERFACE
static ssize_t motor_speed_change_switch_store(struct class *class, struct class_attribute *attr,
						const char *buff, size_t count)
#else
...
#ifdef CONFIG_MOTOR_CLASS_INTERFACE
static ssize_t  motor_speed_change_switch_show(struct class *class, 
				  struct class_attribute *attr, char *buf)
#else
...
#ifdef CONFIG_MOTOR_CLASS_INTERFACE
static ssize_t dhall_detect_switch_store(struct class *class, struct class_attribute *attr,
						const char *buff, size_t count)
#else
...
#ifdef CONFIG_MOTOR_CLASS_INTERFACE
static ssize_t motor_test_store(struct class *class, struct class_attribute *attr,
						const char *buff, size_t count)
#else
...
#ifdef CONFIG_MOTOR_CLASS_INTERFACE
static ssize_t dhall_data_show(struct class *class, struct class_attribute *attr, char *buf)
#else
...
#ifdef CONFIG_MOTOR_CLASS_INTERFACE
static ssize_t dhall_all_reg_show(struct class *class, struct class_attribute *attr, char *buf)
#else
...
#ifdef CONFIG_MOTOR_CLASS_INTERFACE
static ssize_t motor_move_state_show(struct class *class, struct class_attribute *attr, char *buf)
#else
...
#ifdef CONFIG_MOTOR_CLASS_INTERFACE
static ssize_t dhall_irq_count_show(struct class *class, struct class_attribute *attr, char *buf)
#else
...
#ifdef CONFIG_MOTOR_CLASS_INTERFACE
static ssize_t motor_manual2auto_switch_show(struct class *class, struct class_attribute *attr, char *buf)
#else
...
#ifdef CONFIG_MOTOR_CLASS_INTERFACE
static ssize_t motor_manual2auto_switch_store(struct class *class, struct class_attribute *attr,
						const char *buff, size_t count)
#else
...
#ifdef CONFIG_MOTOR_CLASS_INTERFACE
static ssize_t dhall_calibration_show(struct class *class, struct class_attribute *attr, char *buf)
#else
...
#ifdef CONFIG_MOTOR_CLASS_INTERFACE
static ssize_t dhall_calibration_store(struct class *class, struct class_attribute *attr,
						const char *buff, size_t count)
#else
...
static struct class_attribute motor_class_attrs[] = {
	__ATTR(direction, S_IRUGO | S_IWUSR, motor_direction_show, motor_direction_store),
	__ATTR(speed,   S_IRUGO | S_IWUSR, motor_speed_show, motor_speed_store),
	__ATTR(mode,    S_IRUGO | S_IWUSR, motor_mode_show, motor_mode_store),
	__ATTR(enable,  S_IRUGO | S_IWUSR, NULL, motor_enable_store),
	__ATTR(change_speed,   S_IRUGO | S_IWUSR,NULL, motor_change_speed_store),
	__ATTR(move_state,    S_IRUGO | S_IWUSR, motor_move_state_show,NULL),
	__ATTR(config,   S_IRUGO | S_IWUSR, motor_all_config_show,NULL),
	__ATTR(sw_switch,    S_IRUGO | S_IWUSR, motor_sw_switch_show,motor_sw_switch_store),
	__ATTR(speed_change_switch,    S_IRUGO | S_IWUSR, motor_speed_change_switch_show,motor_speed_change_switch_store),
	__ATTR(position,   S_IRUGO | S_IWUSR, motor_position_show,NULL),
	__ATTR(manual2auto_switch,   S_IRUGO | S_IWUSR, motor_manual2auto_switch_show,motor_manual2auto_switch_store),
	__ATTR(motor_test,   S_IRUGO | S_IWUSR, motor_test_show,motor_test_store),
	__ATTR(hall_data,   S_IRUGO | S_IWUSR,dhall_data_show,NULL),
	__ATTR(hall_reg,   S_IRUGO | S_IWUSR,dhall_all_reg_show,NULL),
	__ATTR(hall_irq_count,   S_IRUGO | S_IWUSR,dhall_irq_count_show,NULL),
	__ATTR(hall_calibration,   S_IRUGO | S_IWUSR,dhall_calibration_show,dhall_calibration_store),
	__ATTR(hall_detect_switch,   S_IRUGO | S_IWUSR,dhall_detect_switch_show,dhall_detect_switch_store),
	__ATTR_NULL,
};
#else
...
static void motor_platform_shutdown(struct platform_device *pdev)
{
	if (g_the_chip) {
		oppo_motor_reset_check(g_the_chip);
		g_the_chip->shutting = true;
		if (g_the_chip->motor_switch && g_the_chip->motor_enable) {
