...
void oplus_vooc_fw_type_dt(struct oplus_vooc_chip *chip)
{
	...
	chip->support_11v3a_flashcharger_display = of_property_read_bool(node,
		"qcom,support_11v3a_flashcharger_display");
	chg_debug("support_11v3a_flashcharger_display:%d\n", chip->support_11v3a_flashcharger_display);
