...
#ifdef VENDOR_EDIT
/*chaochao.xie.BSP.Kernel.Storage, 2019-11-27, add control ext4 fsync*/
...
#endif
#ifdef VENDOR_EDIT
/*chaocaho.xie.BSP.Kernel.Storage, 2019-11-27, add to count flush*/
{
...
#ifdef VENDOR_EDIT
#ifndef CONFIG_OPPO_DEBUG_BUILD
